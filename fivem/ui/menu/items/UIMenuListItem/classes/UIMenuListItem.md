[@nativewrappers/fivem](../../../../../../README.md) / [fivem/ui/menu/items/UIMenuListItem](../README.md) / UIMenuListItem

# Class: UIMenuListItem

Defined in: lib/fivem/ui/menu/items/UIMenuListItem.d.ts:4
...
Defined in: lib/fivem/ui/menu/items/UIMenuListItem.d.ts:16
...
| ------ | ------ |
| `text` | `string` |
| `items` | [`ListItem`](../../../modules/ListItem/classes/ListItem.md)[] |
| `startIndex?` | `number` |
| `description?` | `string` |
...
| <a id="listchanged"></a> `listChanged` | `readonly` | [`LiteEvent`](../../../../../utils/LiteEvent/classes/LiteEvent.md) | - | - | lib/fivem/ui/menu/items/UIMenuListItem.d.ts:5 |
| <a id="listselected"></a> `listSelected` | `readonly` | [`LiteEvent`](../../../../../utils/LiteEvent/classes/LiteEvent.md) | - | - | lib/fivem/ui/menu/items/UIMenuListItem.d.ts:6 |
...
| <a id="supportsrightbadge"></a> `supportsRightBadge` | `protected` | `boolean` | [`UIMenuItem`](../../UIMenuItem/classes/UIMenuItem.md).[`supportsRightBadge`](../../UIMenuItem/classes/UIMenuItem.md#supportsrightbadge) | - | lib/fivem/ui/menu/items/UIMenuListItem.d.ts:7 |
| <a id="supportsrightlabel"></a> `supportsRightLabel` | `protected` | `boolean` | [`UIMenuItem`](../../UIMenuItem/classes/UIMenuItem.md).[`supportsRightLabel`](../../UIMenuItem/classes/UIMenuItem.md#supportsrightlabel) | - | lib/fivem/ui/menu/items/UIMenuListItem.d.ts:8 |
...
Defined in: lib/fivem/ui/menu/items/UIMenuListItem.d.ts:24
...
Defined in: lib/fivem/ui/menu/items/UIMenuListItem.d.ts:25
...
Defined in: lib/fivem/ui/menu/items/UIMenuListItem.d.ts:22
...
Defined in: lib/fivem/ui/menu/items/UIMenuListItem.d.ts:23
...
Defined in: lib/fivem/ui/menu/items/UIMenuListItem.d.ts:26
...
Defined in: lib/fivem/ui/menu/items/UIMenuListItem.d.ts:27
...
Defined in: lib/fivem/ui/menu/items/UIMenuListItem.d.ts:17

##### Returns

[`ListItem`](../../../modules/ListItem/classes/ListItem.md)[]
...
Defined in: lib/fivem/ui/menu/items/UIMenuListItem.d.ts:18

##### Parameters

| Parameter | Type |
| ------ | ------ |
| `value` | [`ListItem`](../../../modules/ListItem/classes/ListItem.md)[] |
...
Defined in: lib/fivem/ui/menu/items/UIMenuListItem.d.ts:19
...
Defined in: lib/fivem/ui/menu/items/UIMenuListItem.d.ts:20
...
Defined in: lib/fivem/ui/menu/items/UIMenuListItem.d.ts:21
...
Defined in: lib/fivem/ui/menu/items/UIMenuListItem.d.ts:29
...
Defined in: lib/fivem/ui/menu/items/UIMenuListItem.d.ts:28
