...
[src/common/utils/Vector.ts:578](https://github.com/nativewrappers/fivem/blob/dc30be651dd1d99507081f19ee3707fad2d3aa44/src/common/utils/Vector.ts#L578)
...
| `type` | `public` | `ClassTypes` | `ClassTypes.Vector3` | - | `Vector.type` | `Vector.type` |
| `w?` | `public` | `number` | `undefined` | The w-component of the vector (optional). | `Vector.w` | `Vector.w` |
| `x` | `public` | `number` | `0` | The x-component of the vector. | `Vec3.x`

`Vector.x` | `Vec3.x`

`Vector.x` |
| `y` | `public` | `number` | `x` | The y-component of the vector (optional, defaults to x). | `Vec3.y`

`Vector.y` | `Vec3.y`

`Vector.y` |
| `z` | `public` | `number` | `undefined` | - | `Vec3.z`
...
[src/common/utils/Vector.ts:586](https://github.com/nativewrappers/fivem/blob/dc30be651dd1d99507081f19ee3707fad2d3aa44/src/common/utils/Vector.ts#L586)
...
[src/common/utils/Vector.ts:593](https://github.com/nativewrappers/fivem/blob/dc30be651dd1d99507081f19ee3707fad2d3aa44/src/common/utils/Vector.ts#L593)
