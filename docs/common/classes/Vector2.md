...
[src/common/utils/Vector.ts:558](https://github.com/nativewrappers/fivem/blob/48a3f351defb1a6508113ef71a8290d8cb1a458c/src/common/utils/Vector.ts#L558)
...
| `type` | `public` | `ClassTypes` | `ClassTypes.Vector2` | The type identifier for vectors. | `Vector.type` | - | [src/common/utils/Vector.ts:549](https://github.com/nativewrappers/fivem/blob/48a3f351defb1a6508113ef71a8290d8cb1a458c/src/common/utils/Vector.ts#L549) |
...
| `z?` | `public` | `number` | `undefined` | The z-component of the vector (optional). | - | `Vector.z` | [src/common/utils/Vector.ts:415](https://github.com/nativewrappers/fivem/blob/48a3f351defb1a6508113ef71a8290d8cb1a458c/src/common/utils/Vector.ts#L415) |
| `Zero` | `readonly` | [`Vector2`](Vector2.md) | `undefined` | - | - | - | [src/common/utils/Vector.ts:551](https://github.com/nativewrappers/fivem/blob/48a3f351defb1a6508113ef71a8290d8cb1a458c/src/common/utils/Vector.ts#L551) |
